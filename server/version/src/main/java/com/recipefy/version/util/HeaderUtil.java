...
public class HeaderUtil {
     ...
     */
    public static Long extractUserIdFromHeader() {
        try {
     ...
     */
    public static Long extractRequiredUserIdFromHeader() {
        Long userId = extractUserIdFromHeader();
        if (userId == null) {
     ...
     */
    public static Long extractUserIdFromHeader(Long fallbackUserId) {
        Long userId = extractUserIdFromHeader();
