...
export default function RecipeDetailPage() {
    ...
    useEffect(() => {
        if (params?.id) {
            ...
            const extractedId = typeof recipeIdParam === 'string' ? Number(recipeIdParam) :
                Array.isArray(recipeIdParam) ? Number(recipeIdParam[0]) :
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="mx-auto max-w-4xl text-center">
                    ...
                    <button
                        ...
                        className="bg-[#FF7C75] text-white px-6 py-2 rounded-lg hover:bg-[#FF7C75]/90 transition-colors"
                    >
                        Back to Recipes
                    </button>
                </div>
                    ...
                    <div className="relative z-50 m-4 w-full max-w-lg rounded-lg bg-white p-6 shadow-lg">
                        ...
                        <div className="mt-6 flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2">
                            <button
                                type="button"
                                onClick={() => setShowDeleteDialog(false)}
                                className="border-gray-300 text-gray-700 hover:bg-gray-50 hover:text-gray-900 border rounded-lg px-4 py-2 font-semibold transition-colors"
                                disabled={isDeleting}
                            >
                                Cancel
                            </button>
                            <button
                                ...
                                className="bg-[#FF7C75] text-white hover:bg-rose-600 rounded-lg px-4 py-2 font-semibold transition-colors"
                                disabled={isDeleting}
                            >
